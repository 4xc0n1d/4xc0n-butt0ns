var customcard = {
    init: function() {
        $(".card-header-right .close-card").on('click', function() {
        ...
        }), $(".card-header-right .card-option .fa.fa-spin.ax-chevrons-left").on('click', function() {
            var $this = $(this);
            if ($this.hasClass('ax-chevrons-right')) {
            ...
            $(this).toggleClass("ax-chevrons-right").fadeIn('slow');
